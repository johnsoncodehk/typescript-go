...
//go:generate go -C ../../_tools tool stringer -dir=../internal/core -type=ModuleKind -trimprefix=ModuleKind -output=modulekind_stringer_generated.go
//go:generate go -C ../../_tools tool stringer -dir=../internal/core -type=ScriptTarget -trimprefix=ScriptTarget -output=scripttarget_stringer_generated.go
